...
export default [
	...
	//理财
	{
		...
		meta: {
			title: i18n.global.t("tabbar.financialManagement"),
			requireAuth: false,
			keepAlive: true,
		},
	},
	// 收益明细
	{
		...
		component: () => import("@/views/yuebao/incomeBreakdown.vue"),
		meta: {
			title: i18n.global.t("financialManagement.incomeBreakdown"),
			requireAuth: false,
			keepAlive: true,
		},
	},
	// 买入
	{
		path: "/buy",
		name: "buy",
		component: () => import("@/views/yuebao/buy.vue"),
		meta: {
			title: i18n.global.t("financialManagement.buy"),
			requireAuth: false,
			keepAlive: true,
		},
	},
	// 转入
	{
		path: "/transferIn",
		name: "transferIn",
		component: () => import("@/views/yuebao/transferIn.vue"),
		meta: {
			title: i18n.global.t("financialManagement.transferIn"),
			requireAuth: false,
			keepAlive: true,
		},
	},
	// 转出
	{
		path: "/transferOut",
		name: "transferOut",
		component: () => import("@/views/yuebao/transferOut.vue"),
		meta: {
			title: i18n.global.t("financialManagement.transferOut"),
			requireAuth: false,
			keepAlive: true,
		},
	},
	// 持有资产
	{
		path: "/holdingAssets",
		name: "holdingAssets",
		component: () => import("@/views/yuebao/holdingAssets.vue"),
		meta: {
			title: i18n.global.t("financialManagement.holdingAssets"),
			requireAuth: false,
			keepAlive: true,
		},
	},
	...
	//物流信息
	{
		...
		meta: {
			title: i18n.global.t("router.transport"),
			requireAuth: false,
			keepAlive: true,
		},
	},
	//银行
	{
		path: "/bankRecharge",
		name: "bankRecharge",
		component: () => import("@/views/bankRecharge/index.vue"),
		meta: {
			title: i18n.global.t("router.bankRecharge"),
			requireAuth: false,
			keepAlive: true,
		},
	},
	//支付宝/微信
	{
		...
		name: "zhifubaoRecharge",
		component: () => import("@/views/zhifubaoRecharge/index.vue"),
		meta: {
			title: i18n.global.t("router.zhifubaoRecharge"),
			requireAuth: false,
			keepAlive: true,
		},
	},
	//邮箱登录
	{
		path: "/emailLogin",
		name: "emailLogin",
		component: () => import("@/views/emailLogin/index.vue"),
		meta: {
			title: i18n.global.t("router.emailLogin"),
			requireAuth: false,
			keepAlive: true,
		},
	},
	//图片展示
	{
		path: "/imageShow",
		name: "imageShow",
		component: () => import("@/views/imageShow/index.vue"),
		meta: {
			title: i18n.global.t("router.imageShow"),
			requireAuth: false,
			keepAlive: true,
		},
	},
	//vip联盟
	{
		...
		meta: {
			title: i18n.global.t("router.vip"),
			requireAuth: false,
			keepAlive: true,
		},
	}, //vip联盟-规则说明
	{
		path: "/VipRule",
		name: "VipRule",
		component: () => import("@/views/VipRule/index.vue"),
		meta: {
			title: i18n.global.t("router.VipRule"),
			requireAuth: false,
			keepAlive: true,
		},
	},
	//奖池排行榜
	{
		path: "/prizePoolRanking",
		name: "prizePoolRanking",
		component: () => import("@/views/prizePoolRanking/index.vue"),
		meta: {
			title: i18n.global.t("router.prizePoolRanking"),
			requireAuth: false,
			keepAlive: true,
		},
	},
	//奖池排行榜
	{
		...
		meta: {
			title: i18n.global.t("router.weixin"),
			requireAuth: false,
			keepAlive: true,
		},
	},
