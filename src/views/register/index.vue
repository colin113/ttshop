...
const onSubmit2 = async () => {
  if (query.value.password != query.value.repassword) {
    showFailToast(t("newword.diffPassword"));
    return
  }
  ...
  if (res.code === 1) {
    ...
    await router.push({ path: '/code', query: { status: 0 } })
    ...
    <main>
      ...
      <div class="mt-60">
        ...
        <div class="pt-6 px-10">
          <van-button block color="#191919" plain round style="
                  height: 45px;
        ...
        <div v-if="showLogin === $t('login.login')" class="h-3/5 bg-white rounded-t-2xl fixed bottom-0"
          ...
          <van-form class="mx-3 mt-6" @submit="onSubmit1()">
            <div class="mx-3">
              ...
              <div>
                <van-field v-model="loginInfo.account" :placeholder="$t('login.enterPhoneNumberOrEmail')" :rules="[
                  {
                    required: true,
                    message: $t('login.enterPhoneNumberOrEmail'),
                  },
            ...
            <div class="mx-3">
              ...
              <div>
                <van-field v-model="loginInfo.password" :placeholder="$t('login.enterPassword')" :rules="[
                  { required: true, message: $t('login.enterPassword') },
                ]" class="border border-gray-500 border-dotted rounded-lg" type="password" />
              </div>
            </div>
            <div class="flex mx-3 justify-between mt-6">
              <div>
                <span class="text-black"> {{ $t("login.noAccount") }}</span>
                <span class="pl-1.5 text-blue-500" @click="showLogin = $t('login.register')">
            ...
            <div class="bg-black mx-3 h-16 rounded-lg flex justify-center items-center text-white mt-10">
              <van-button native-type="submit" @click="toHome">
          ...
          <div>
            <van-form class="mt-6" @submit="onSubmit2()">
              ...
              <!-- <div class="mx-3">
                ...
                <div>
                  <van-field v-model="query.mer_name" :rules="[
              ...
              <!-- <div class="mx-3">
                ...
                <div>
                  <van-field v-model="query.mer_address" :placeholder="$t('login.enterStoreAddress')" :rules="[
                    {
                      required: true,
                      message: $t('login.enterStoreAddress'),
                    },
                  ]" class="border border-gray-500 border-dotted rounded-lg" />
                </div>
              </div> -->
              ...
              <!-- <div class="mx-3">
                ...
                <div>
                  <van-field v-model="query.country" :placeholder="$t('login.enterCountry')" :rules="[
              ...
              <!-- <div class="mx-3">
                ...
                <div>
                  <van-field v-model="query.mer_phone" :placeholder="$t('login.uploadPhoneNumber')" :rules="[
                    {
                      required: true,
                      message: $t('login.uploadPhoneNumber'),
                    },
                  ]" class="border border-gray-500 border-dotted rounded-lg" />
                </div>
              </div> -->
              ...
              <!-- <div class="mx-3">
                ...
                <div>
                  <van-field v-model="query.real_name" :placeholder="$t('login.enterRealName')" :rules="[
              ...
              <!-- <div class="mx-3">
                ...
                <div>
                  <van-field v-model="query.mer_email" :placeholder="$t('login.enterEmail')" :rules="[
              ...
              <!-- <div class="mx-3">
                ...
                <div>
                  <van-field v-model="query.password" :placeholder="$t('newword.enterPassword')" :rules="[
              ...
              <!-- <div class="mx-3">
                ...
                <div>
                  <van-field v-model="query.repassword" :placeholder="$t('newword.reEnterPassword')" :rules="[
