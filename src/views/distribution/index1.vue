...
<template>
					...
					<div v-for="item in List" class="bg-white rounded-md back_4 ">
						...
						<div class="px-3">
							...
							<div class="flex items-center pt-0.5 py-3">
								...
								<div class="text-sm text-white ml-auto px-3 bg-black rounded-md py-1"
	...
	<van-action-sheet v-model:show="Price_filtering_show">
		<div class="mx-6">
			<h5 class="text-center text-xl p-3">价格筛选</h5>
			...
			<div class="text-sm text-white ml-auto p-3 bg-black rounded-md text-center mb-6" @click="screen_item()">提交
			</div>
		</div>
	</van-action-sheet>
</template>
