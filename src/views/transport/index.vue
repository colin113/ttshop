...
<template>
  ...
  <main>
    <div class="mt-3 rounded-md" style="display: flex;flex-direction: column;height: 100vh;">
      <div class="bg-white rounded-md mx-3" style="height: 100px;">
        <van-row>
          <van-col span="23" class="t_num">
            <span>{{ $t("orderDetail.trackingNumber") }}</span>
            <span id="ts-order">{{ delivery_no }}</span>
            <img class="btn_copy" src="@/assets/image/transport/ic_copy.png" @click="copy">
          </van-col>
          <van-col span="1" class="right_bg">
            <!-- <span>电子存根</span>
                                  <van-icon name="arrow" /> -->
          </van-col>
        </van-row>
      ...
      <div class="image-container">
        <div class="div-send">
          <van-row>
            <van-col span="24">
              <span class="dis_tip_child">{{ $t("transoprt.start") }}</span>
            </van-col>
            <!-- <van-col span="0">
        ...
        <!-- <img src="@/assets/image/transport/bg_car.png" class="car-image"> -->
        <div class="div-receive">
          <van-row>
            <van-col span="24">
              <span class="dis_tip_child">{{ $t("transoprt.destination") }}</span>
            </van-col>
            <!-- <van-col span="12">
                        <span class="dis_tip_child">台湾省</span>
                      </van-col> -->
      ...
      <div class="bg-white rounded-t-lg bottom_contain">
        <div class="text-lg font-semibold" style="font-size: 18px;color: #252728;">
          ...
          <div class="mt-2">
            <van-icon name="location" color="#3A86F9" />
            <span style="font-size: 12px;color: #888;margin-left: 5px;">{{ $t("orderDetail.shippingAddress") }} {{
