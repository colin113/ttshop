...
<template>
    ...
    >
      <div v-for="item in List" class="bg-white mx-3 mt-3 rounded-md back_3 back_4">
        <div class="flex items-center pt-1.5">
          ...
          <span v-if="item.status===-2" class="ml-auto mt-1 mr-3">{{ $t("order.refunded") }}</span>
  ...
  <van-action-sheet v-model:show="showActionSheet" :overlay="false" :round="false">
    <payPassword :price="totalcost" @close="()=>showActionSheet=false" @send-data="confirmdata" style="height: 54vh;"/>
  </van-action-sheet>
