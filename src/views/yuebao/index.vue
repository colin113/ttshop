...
import { financing, financingList } from "@/api/index";
...
const toBuy = (e) => {
  ...
  router.push({ name: "buy", query: { item: item } });
};
</script>
...
<template>
  ...
  <div
    class="bg-white mx-3 mt-[10px] rounded-md back_4 pt-[32px] pb-[39px] px-[52px]"
  >
    <div class="flex items-center justify-center text-[#191919]/60">
      <img src="@/assets/icons/余额.svg" alt="" />
      <span class="ml-[5px] leading-none">{{
        $t("financialManagement.totalAmountOfFinancing")
      }}</span>
    </div>
    <div
      @click="router.push('/holdingAssets')"
      class="flex items-center justify-center mt-[8px] mb-[30px]"
    >
