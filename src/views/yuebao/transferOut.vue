...
<template>
	<van-nav-bar :title="$t('financialManagement.transferOut')" left-arrow @click-left="onClickLeft"
	...
	<div class="flex items-center mx-[16px] mt-[29px] mb-[32px]">
      ...
      $t("financialManagement.incomingAccount")
		...
		<img src="@/assets/icons/Transfer_out.png" alt="" />
    ...
    ">
		...
		<div class="mt-[14px]">
			<span class="text-[#191919]/60 text-[12px] mr-[16px]">{{ $t("financialManagement.changePassBalance") }}：{{
