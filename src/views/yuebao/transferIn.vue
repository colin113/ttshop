<script setup>
import { financingTransfer } from "@/api/index";
...
<template>
  <van-nav-bar
    :title="$t('financialManagement.transferIn')"
    left-arrow
  ...
  <div class="flex items-center mx-[16px] mt-[29px] mb-[32px]">
    ...
    <img src="@/assets/icons/转入.png" alt="" />
  ...
  >
    ...
    <div class="mt-[14px]">
      <span class="text-[#191919]/60 text-[12px] mr-[16px]"
        >{{ $t("fundsRecords.money") }}：{{ userStore.MerInfo.mer_money }}</span
      >
