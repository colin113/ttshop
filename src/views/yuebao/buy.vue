...
<template>
	<van-nav-bar :title="$t('financialManagement.buy')" left-arrow @click-left="onClickLeft">
	</van-nav-bar>
	<div class="bgi text-[20px] pl-[57px]">
		{{ $t("financialManagement.revenueEnhancement") }}{{ item?.interest_rate }}%
	</div>
	<div class="bg-white rounded-[20px] px-[16px] pt-[20px] pb-[40px]" style="
      box-shadow: 0px -3px 10px 0px rgba(0, 0, 0, 0.1);
      height: calc(100dvh - 238px);
    ">
		<div>{{ $t("financialManagement.purchaseAmount") }}</div>
		<div class="pt-[29px] pb-[21px] flex items-center" style="border-bottom: 1px solid rgba(25, 25, 25, 0.1)">
			<img src="@/assets/icons/inputMoney.svg" class="mr-[5px]" alt="" />
...
<style scoped lang="scss">
	...
	.bgi {
		background-image: url("@/assets/image/zrbj.png");
